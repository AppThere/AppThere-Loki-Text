...
pub fn build_font_resolver() -> MapFontResolver {
    ...
    r.add_font("atkinson hyperlegible next", 400, false, ATKINSON_REGULAR.to_vec());
    r.add_font("atkinson hyperlegible next", 700, false, ATKINSON_BOLD.to_vec());
    r.add_font("atkinson hyperlegible next", 400, true,  ATKINSON_ITALIC.to_vec());
    r.add_font("atkinson hyperlegible next", 700, true,  ATKINSON_BOLD_ITALIC.to_vec());
    // Short alias
    ...
    r.add_font("cormorant garamond", 400, false, CORMORANT_VARIABLE.to_vec());
    r.add_font("cormorant garamond", 700, false, CORMORANT_VARIABLE.to_vec());
