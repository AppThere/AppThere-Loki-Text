	...
	>
		...
		>
			...
			<div class="modal-body">
				<div class="app-info">
					<img src="/icons/128x128.png" alt="Loki Logo" class="app-logo" />
					<h3>AppThere Loki Text</h3>
					<p class="version">Version 0.1.0</p>
					<p class="description">A distraction-free ODT editor for Android and Desktop.</p>
				</div>
				...
				<div class="licenses">
					...
					<p class="legal">Copyright © 2026 AppThere. All rights reserved.</p>
				</div>
			</div>
