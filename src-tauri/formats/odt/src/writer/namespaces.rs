...
pub fn push_content_ns(elem: &mut BytesStart) {
    push_common_ns(elem);
    elem.push_attribute(("xmlns:table", "urn:oasis:names:tc:opendocument:xmlns:table:1.0"));
    elem.push_attribute(("xmlns:draw", "urn:oasis:names:tc:opendocument:xmlns:drawing:1.0"));
    elem.push_attribute(("xmlns:number", "urn:oasis:names:tc:opendocument:xmlns:datastyle:1.0"));
    elem.push_attribute(("xmlns:svg", "urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0"));
    elem.push_attribute(("xmlns:chart", "urn:oasis:names:tc:opendocument:xmlns:chart:1.0"));
    elem.push_attribute(("xmlns:dr3d", "urn:oasis:names:tc:opendocument:xmlns:dr3d:1.0"));
    elem.push_attribute(("xmlns:math", "http://www.w3.org/1998/Math/MathML"));
    elem.push_attribute(("xmlns:form", "urn:oasis:names:tc:opendocument:xmlns:form:1.0"));
    elem.push_attribute(("xmlns:script", "urn:oasis:names:tc:opendocument:xmlns:script:1.0"));
...
fn push_common_ns(elem: &mut BytesStart) {
    elem.push_attribute(("xmlns:office", "urn:oasis:names:tc:opendocument:xmlns:office:1.0"));
    elem.push_attribute(("xmlns:text", "urn:oasis:names:tc:opendocument:xmlns:text:1.0"));
    elem.push_attribute(("xmlns:style", "urn:oasis:names:tc:opendocument:xmlns:style:1.0"));
    elem.push_attribute(("xmlns:fo", "urn:oasis:names:tc:opendocument:xmlns:xsl-fo-compatible:1.0"));
    elem.push_attribute(("xmlns:xlink", "http://www.w3.org/1999/xlink"));
    elem.push_attribute(("xmlns:dc", "http://purl.org/dc/elements/1.1/"));
    elem.push_attribute(("xmlns:meta", "urn:oasis:names:tc:opendocument:xmlns:meta:1.0"));
}
